...
if [[ $# -eq 0 || ( $# -eq 1 && "$1" == "build" ) ]]; then
	...
	then
		printf "TEST CASE 1 \e[1;31mFAILED\e[0m\n"
		...
		then
			...
			printf "TEST CASE 1 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 2 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 2 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		...
		then
			printf "TEST CASE 3 \e[1;31mFAILED\e[0m\n"
		...
		then
			...
			printf "TEST CASE 3 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 4 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 4 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 5 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 5 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -b $build_file -s $sess_file -r PC,GO -p PC,GO -w PFPC,MFNC > /dev/null; } 2>&1 )"
	if [[ $err =~ "Cannot specify both session and build file. Exiting..." ]]
	then
		printf "TEST CASE 6 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 6 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -b $build_file -r PC,GO -p PC,GO -w PFPC,MFNC > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify an output basename. Exiting..." ]]
	then
		printf "TEST CASE 7 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 7 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -b $build_file -v TUI > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify an output basename. Exiting..." ]]
	then
		printf "TEST CASE 8 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 8 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -b $build_file -v GUI > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify an output basename. Exiting..." ]]
	then
		printf "TEST CASE 9 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 9 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -b $build_file -i TEST_INPUT.sim > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify an output basename. Exiting..." ]]
	then
		printf "TEST CASE 10 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 10 \e[1;31mFAILED\e[0m\n"
	fi
fi
...
if [[ $# -eq 0 || ( $# -eq 1 && "$1" == "run" ) ]]; then
	...
	then
		printf "TEST CASE 11 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 11 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 12 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 12 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 13 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 13 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 14 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 14 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 15 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 15 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 16 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 16 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 17 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 17 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 18 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 18 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 19 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 19 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	then
		printf "TEST CASE 20 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 20 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	if [[ $err =~ "Cannot specify both session and build file. Exiting..." ]]
	then
		printf "TEST CASE 21 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 21 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -s $sess_file -b $build_file -i $workflow_1_input -o TEST_CASE_22 -r MF,GO > /dev/null; } 2>&1 )"
	if [[ $err =~ "Cannot specify both session and build file. Exiting..." ]]
	then
		printf "TEST CASE 22 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 22 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -s $sess_file -b $build_file -i $workflow_1_input -o TEST_CASE_23 -r MF,GO -p MF,GO > /dev/null; } 2>&1 )"
	if [[ $err =~ "Cannot specify both session and build file. Exiting..." ]]
	then
		printf "TEST CASE 23 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 23 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -s $sess_file -b $build_file -i $workflow_1_input -o TEST_CASE_24 -r MF,GO -p MF,GO -w PFPC,MFNC > /dev/null; } 2>&1 )"
	if [[ $err =~ "Cannot specify both session and build file. Exiting..." ]]
	then
		printf "TEST CASE 24 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 24 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -s $sess_file -r MF,GO > /dev/null; } 2>&1 )"
	if [[ $err =~ "no input simulation specified in run mode. exiting..." ]]
	then
		printf "TEST CASE 25 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 25 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary -s $sess_file -o TEST_CASE_26 -r MF,GO > /dev/null; } 2>&1 )"
	if [[ $err =~ "no input simulation specified in run mode. exiting..." ]]
	then
		printf "TEST CASE 26 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 26 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 33 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 33 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 34 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 34 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 35 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 35 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 36 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 36 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 37 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 37 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 38 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 38 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 39 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 39 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary --binary -s $sess_file -i $workflow_1_input -o TEST_CASE_40 --cascade > /dev/null; } 2>&1 )"
	if [[ $err =~ "Mutually exclusive or duplicate pfpc plasticity arguments found. Exiting..." ]]
	then
		printf "TEST CASE 40 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 40 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary --cascade -s $sess_file -i $workflow_1_input -o TEST_CASE_41 --binary > /dev/null; } 2>&1 )"
	if [[ $err =~ "Mutually exclusive or duplicate pfpc plasticity arguments found. Exiting..." ]]
	then
		printf "TEST CASE 41 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 41 \e[1;31mFAILED\e[0m\n"
	fi
	
	err="$( { $binary --binary -s $sess_file -i $workflow_1_input -o TEST_CASE_42 --binary > /dev/null; } 2>&1 )"
	if [[ $err =~ "Mutually exclusive or duplicate pfpc plasticity arguments found. Exiting..." ]]
	then
		printf "TEST CASE 42 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 42 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 43 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 43 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 44 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 44 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 45 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 45 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 46 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 46 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 47 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 47 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 48 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 48 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 49 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 49 \e[1;31mFAILED\e[0m\n"
	fi
	...
	then
		printf "TEST CASE 50 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 50 \e[1;31mFAILED\e[0m\n"
	fi
fi
...
if [[ $# -eq 0 || ( $# -eq 1 && "$1" == "connect" ) ]]; then
	...
	then
		printf "TEST CASE 51 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 51 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	if ! $binary -b $build_file -o TEST_CASE_52 -c MFGR,MFGO
	then
		printf "TEST CASE 52 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 52 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	...
	if ! $( $binary -i $workflow_2_input -s $sess_file -o TEST_CASE_53 -c MFGR > /dev/null 2>&1 )
	then
		printf "TEST CASE 53 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 53 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	if ! $( $binary -i $workflow_2_input -s $sess_file -o TEST_CASE_54 -c MFGR,MFGO > /dev/null 2>&1 )
	then
		printf "TEST CASE 54 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		...
		then
			...
			printf "TEST CASE 54 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi

	if ! $( $binary -i $workflow_2_input -o TEST_CASE_55 -c MFGR > /dev/null 2>&1 )
	then
		printf "TEST CASE 55 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		if ! [ -d "${data_out_dir}TEST_CASE_55" ]
		then
			printf "TEST CASE 55 \e[1;31mFAILED\e[0m\n"
			printf "\tREASON: Output folder 'TEST_CASE_55' was not produced\n"
		elif ! [ -e "${data_out_dir}TEST_CASE_55/TEST_CASE_55_PRE.mfgr" ] && \
		     ! [ -e "${data_out_dir}TEST_CASE_55/TEST_CASE_55_POST.mfgr" ]
		then
			printf "TEST CASE 55 \e[1;31mFAILED\e[0m\n"
			printf "\tREASON: Pre/Post Output files with base and extension 'TEST_CASE_55.mfgr' were not produced\n"
		else
			printf "TEST CASE 55 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	if ! $( $binary -i $workflow_2_input -o TEST_CASE_56 -c MFGR,MFGO > /dev/null 2>&1 )
	then
		printf "TEST CASE 56 \e[1;31mFAILED\e[0m\n"
		printf "\tREASON: the command returned non-zero exit status\n"
	else
		if ! [ -d "${data_out_dir}TEST_CASE_56" ]
		then
			printf "TEST CASE 56 \e[1;31mFAILED\e[0m\n"
			printf "\tREASON: Output folder 'TEST_CASE_56' was not produced\n"
		elif ! [ -e "${data_out_dir}TEST_CASE_56/TEST_CASE_56_PRE.mfgr" ] && \
		     ! [ -e "${data_out_dir}TEST_CASE_56/TEST_CASE_56_POST.mfgr" ] && \
		     ! [ -e "${data_out_dir}TEST_CASE_56/TEST_CASE_56_PRE.mfgo" ] && \
		     ! [ -e "${data_out_dir}TEST_CASE_56/TEST_CASE_56_POST.mfgo" ]
		then
			printf "TEST CASE 56 \e[1;31mFAILED\e[0m\n"
			printf "\tREASON: Pre/Post Output files with base and extension 'TEST_CASE_56.mfgr' and 'TEST_CASE_56.mfgo' were not produced\n"
		else
			printf "TEST CASE 56 \e[1;32mPASSED\e[0m\n"
			(( passed_tests++ ))
		fi
	fi
	#invalid test cases
	err="$( { $binary -v GUI -i $workflow_2_input -o TEST_CASE_57 -c MFGR > /dev/null; } 2>&1 )"
	if [[ $err =~ "Cannot specify visual mode 'GUI' in connectivity collect mode. Exiting..." ]]
	then
		printf "TEST CASE 57 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 57 \e[1;31mFAILED\e[0m\n"
	fi
	err="$( { $binary -i $workflow_2_input -o TEST_CASE_58 > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify at least one connectivity array to save. Exiting..." ]]
	then
		printf "TEST CASE 58 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 58 \e[1;31mFAILED\e[0m\n"
	fi
	err="$( { $binary -i $workflow_2_input -c MFGR > /dev/null; } 2>&1 )"
	if [[ $err =~ "You must specify an output basename. Exiting..." ]]
	then
		printf "TEST CASE 59 \e[1;32mPASSED\e[0m\n"
		(( passed_tests++ ))
	else
		printf "TEST CASE 59 \e[1;31mFAILED\e[0m\n"
	fi
fi
