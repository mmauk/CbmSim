  ...
  struct tuning_window tw = {
      ...
      .tuning_buttons = {
          ...
          {gtk_adjustment_new(gIncMFtoGO, 0.0, 1.0, 0.0001, 0.1, 0.0),
           ...
           4,
           {NULL, "MF-GO", 0, 1},
           {"activate", G_CALLBACK(on_update_weight), &gIncMFtoGO, false}},
          {gtk_adjustment_new(gIncGRtoGO, 0.0, 1.0, 0.0001, 0.1, 0.0),
           ...
           4,
           {NULL, "GR-GO", 0, 2},
           {"activate", G_CALLBACK(on_update_weight), &gIncGRtoGO, false}},
          {gtk_adjustment_new(gIncDirectGOtoGR, 0.0, 1.0, 0.01, 0.1, 0.0),
           ...
           2,
           {NULL, "GO-GR", 0, 3},
           {"activate", G_CALLBACK(on_update_weight), &gIncDirectGOtoGR,
            false}},
          {gtk_adjustment_new(gGABAIncGOtoGO, 0.0, 1.0, 0.01, 0.1, 0.0),
           ...
           2,
           {NULL, "GO-GO", 2, 0},
           {"activate", G_CALLBACK(on_update_weight), &gGABAIncGOtoGO, false}},
