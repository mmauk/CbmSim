...
{
	coupleRiRjRatioGO          = std::stof(s_file.parsed_var_sections["activity"].param_map["coupleRiRjRatioGO"].value); 
	...
	eGABAGO                    = std::stof(s_file.parsed_var_sections["activity"].param_map["eGABAGO"].value); 
	eGOGR                      = std::stof(s_file.parsed_var_sections["activity"].param_map["eGOGR"].value); 
	eMFGR                      = std::stof(s_file.parsed_var_sections["activity"].param_map["eMFGR"].value); 
	eMGluRGO                   = std::stof(s_file.parsed_var_sections["activity"].param_map["eMGluRGO"].value); 
	...
	gGABADecTauGOtoGO          = std::stof(s_file.parsed_var_sections["activity"].param_map["gGABADecTauGOtoGO"].value); 
	gIncDirectGOtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncDirectGOtoGR"].value); 
	gDirectTauGOtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gDirectTauGOtoGR"].value); 
	gIncFracSpilloverGOtoGR    = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncFracSpilloverGOtoGR"].value); 
	gSpilloverTauGOtoGR        = std::stof(s_file.parsed_var_sections["activity"].param_map["gSpilloverTauGOtoGR"].value); 
	gGABAIncGOtoGO             = std::stof(s_file.parsed_var_sections["activity"].param_map["gGABAIncGOtoGO"].value); 
	gDecTauGRtoGO              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauGRtoGO"].value); 
	gIncGRtoGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGRtoGO"].value); 
	gDecTauMFtoGO              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauMFtoGO"].value); 
	gIncMFtoGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncMFtoGO"].value); 
	gConstGO                   = std::stof(s_file.parsed_var_sections["activity"].param_map["gConstGO"].value); 
	NMDA_AMPAratioMFGO         = std::stof(s_file.parsed_var_sections["activity"].param_map["NMDA_AMPAratioMFGO"].value); 
	gDecTauMFtoGONMDA          = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauMFtoGONMDA"].value); 
	gIncDirectMFtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncDirectMFtoGR"].value); 
	gDirectTauMFtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gDirectTauMFtoGR"].value); 
	gIncFracSpilloverMFtoGR    = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncFracSpilloverMFtoGR"].value); 
	gSpilloverTauMFtoGR        = std::stof(s_file.parsed_var_sections["activity"].param_map["gSpilloverTauMFtoGR"].value); 
	recoveryTauMF              = std::stof(s_file.parsed_var_sections["activity"].param_map["recoveryTauMF"].value); 
	fracDepMF                  = std::stof(s_file.parsed_var_sections["activity"].param_map["fracDepMF"].value); 
	recoveryTauGO              = std::stof(s_file.parsed_var_sections["activity"].param_map["recoveryTauGO"].value); 
	fracDepGO                  = std::stof(s_file.parsed_var_sections["activity"].param_map["fracDepGO"].value); 
	gIncMFtoUBC                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncMFtoUBC"].value); 
	gIncGOtoUBC                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGOtoUBC"].value); 
	gIncUBCtoUBC               = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoUBC"].value); 
	gIncUBCtoGO                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoGO"].value); 
	gIncUBCtoGR                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoGR"].value); 
	gKIncUBC                   = std::stof(s_file.parsed_var_sections["activity"].param_map["gKIncUBC"].value); 
	gKTauUBC                   = std::stof(s_file.parsed_var_sections["activity"].param_map["gKTauUBC"].value); 
	gConstUBC                  = std::stof(s_file.parsed_var_sections["activity"].param_map["gConstUBC"].value); 
	threshTauUBC               = std::stof(s_file.parsed_var_sections["activity"].param_map["threshTauUBC"].value); 
	gMGluRDecGRtoGO            = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRDecGRtoGO"].value); 
	gMGluRIncDecayGO           = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRIncDecayGO"].value); 
	gMGluRIncScaleGO           = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRIncScaleGO"].value); 
	gMGluRScaleGRtoGO          = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRScaleGRtoGO"].value); 
	...
	gluDecayGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gluDecayGO"].value); 
  ...
  grStpInc            = std::stof(s_file.parsed_var_sections["activity"].param_map["grStpInc"].value);
	...
	cascPlastProbMax           = std::stof(s_file.parsed_var_sections["activity"].param_map["cascPlastProbMax"].value);
	cascPlastWeightLow         = std::stof(s_file.parsed_var_sections["activity"].param_map["cascPlastWeightLow"].value);
	cascPlastWeightHigh        = std::stof(s_file.parsed_var_sections["activity"].param_map["cascPlastWeightHigh"].value);
	binPlastProbMin            = std::stof(s_file.parsed_var_sections["activity"].param_map["binPlastProbMin"].value);
	binPlastProbMax            = std::stof(s_file.parsed_var_sections["activity"].param_map["binPlastProbMax"].value); 
	binPlastWeightLow          = std::stof(s_file.parsed_var_sections["activity"].param_map["binPlastWeightLow"].value);
	binPlastWeightHigh         = std::stof(s_file.parsed_var_sections["activity"].param_map["binPlastWeightHigh"].value);
	...
	mGluRDecayGO               = std::stof(s_file.parsed_var_sections["activity"].param_map["mGluRDecayGO"].value); 
	mGluRScaleGO               = std::stof(s_file.parsed_var_sections["activity"].param_map["mGluRScaleGO"].value); 
	maxExtIncVIO               = std::stof(s_file.parsed_var_sections["activity"].param_map["maxExtIncVIO"].value); 
	gmaxAMPADecTauMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["gmaxAMPADecTauMFtoNC"].value); 
	synLTDStepSizeMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTDStepSizeMFtoNC"].value); 
	synLTDPCPopActThreshMFtoNC = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTDPCPopActThreshMFtoNC"].value); 
	synLTPStepSizeMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTPStepSizeMFtoNC"].value); 
	synLTPPCPopActThreshMFtoNC = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTPPCPopActThreshMFtoNC"].value); 
	gmaxNMDADecTauMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["gmaxNMDADecTauMFtoNC"].value); 
	...
	msPerHistBinMF             = std::stof(s_file.parsed_var_sections["activity"].param_map["msPerHistBinMF"].value); 
	...
	rawGLeakGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakGO"].value); 
	...
	rawGMFAMPAIncNC            = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGMFAMPAIncNC"].value); 
	rawGMFNMDAIncNC            = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGMFNMDAIncNC"].value); 
	threshDecTauBC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauBC"].value); 
	threshDecTauGO             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauGO"].value); 
	threshDecTauUBC            = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauUBC"].value); 
	...
	threshMaxGO                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxGO"].value); 
	...
	rawGRGOW                   = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGRGOW"].value); 
	rawMFGOW                   = std::stof(s_file.parsed_var_sections["activity"].param_map["rawMFGOW"].value); 
	gogrW                      = std::stof(s_file.parsed_var_sections["activity"].param_map["gogrW"].value); 
	gogoW                      = std::stof(s_file.parsed_var_sections["activity"].param_map["gogoW"].value); 
