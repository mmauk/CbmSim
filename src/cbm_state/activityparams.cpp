...
{
	coupleRiRjRatioGO          = std::stof(s_file.parsed_var_sections["activity"].param_map["coupleRiRjRatioGO"]); 
	...
	eGABAGO                    = std::stof(s_file.parsed_var_sections["activity"].param_map["eGABAGO"]); 
	...
	eMGluRGO                   = std::stof(s_file.parsed_var_sections["activity"].param_map["eMGluRGO"]); 
	...
	NMDA_AMPAratioMFGO         = std::stof(s_file.parsed_var_sections["activity"].param_map["NMDA_AMPAratioMFGO"]); 
	gDecTauMFtoGONMDA          = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauMFtoGONMDA"]); 
	gIncDirectMFtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncDirectMFtoGR"]); 
	gDirectTauMFtoGR           = std::stof(s_file.parsed_var_sections["activity"].param_map["gDirectTauMFtoGR"]); 
	gIncFracSpilloverMFtoGR    = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncFracSpilloverMFtoGR"]); 
	gSpilloverTauMFtoGR        = std::stof(s_file.parsed_var_sections["activity"].param_map["gSpilloverTauMFtoGR"]); 
	recoveryTauMF              = std::stof(s_file.parsed_var_sections["activity"].param_map["recoveryTauMF"]); 
	fracDepMF                  = std::stof(s_file.parsed_var_sections["activity"].param_map["fracDepMF"]); 
	recoveryTauGO              = std::stof(s_file.parsed_var_sections["activity"].param_map["recoveryTauGO"]); 
	fracDepGO                  = std::stof(s_file.parsed_var_sections["activity"].param_map["fracDepGO"]); 
	gIncMFtoUBC                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncMFtoUBC"]); 
	gIncGOtoUBC                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGOtoUBC"]); 
	gIncUBCtoUBC               = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoUBC"]); 
	gIncUBCtoGO                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoGO"]); 
	gIncUBCtoGR                = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncUBCtoGR"]); 
	gKIncUBC                   = std::stof(s_file.parsed_var_sections["activity"].param_map["gKIncUBC"]); 
	gKTauUBC                   = std::stof(s_file.parsed_var_sections["activity"].param_map["gKTauUBC"]); 
	gConstUBC                  = std::stof(s_file.parsed_var_sections["activity"].param_map["gConstUBC"]); 
	threshTauUBC               = std::stof(s_file.parsed_var_sections["activity"].param_map["threshTauUBC"]); 
	gMGluRDecGRtoGO            = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRDecGRtoGO"]); 
	gMGluRIncDecayGO           = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRIncDecayGO"]); 
	gMGluRIncScaleGO           = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRIncScaleGO"]); 
	gMGluRScaleGRtoGO          = std::stof(s_file.parsed_var_sections["activity"].param_map["gMGluRScaleGRtoGO"]); 
	...
	gluDecayGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gluDecayGO"]); 
	gluScaleGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gluScaleGO"]); 
	goGABAGOGOSynDepF          = std::stof(s_file.parsed_var_sections["activity"].param_map["goGABAGOGOSynDepF"]); 
	goGABAGOGOSynRecTau        = std::stof(s_file.parsed_var_sections["activity"].param_map["goGABAGOGOSynRecTau"]); 
	...
	mGluRDecayGO               = std::stof(s_file.parsed_var_sections["activity"].param_map["mGluRDecayGO"]); 
	mGluRScaleGO               = std::stof(s_file.parsed_var_sections["activity"].param_map["mGluRScaleGO"]); 
	maxExtIncVIO               = std::stof(s_file.parsed_var_sections["activity"].param_map["maxExtIncVIO"]); 
	gmaxAMPADecTauMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["gmaxAMPADecTauMFtoNC"]); 
	synLTDStepSizeMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTDStepSizeMFtoNC"]); 
	synLTDPCPopActThreshMFtoNC = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTDPCPopActThreshMFtoNC"]); 
	synLTPStepSizeMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTPStepSizeMFtoNC"]); 
	synLTPPCPopActThreshMFtoNC = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTPPCPopActThreshMFtoNC"]); 
	gmaxNMDADecTauMFtoNC       = std::stof(s_file.parsed_var_sections["activity"].param_map["gmaxNMDADecTauMFtoNC"]); 
	...
	msPerHistBinMF             = std::stof(s_file.parsed_var_sections["activity"].param_map["msPerHistBinMF"]); 
	...
	rawGLeakGO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakGO"]); 
	...
	rawGMFAMPAIncNC            = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGMFAMPAIncNC"]); 
	rawGMFNMDAIncNC            = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGMFNMDAIncNC"]); 
	threshDecTauBC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauBC"]); 
	threshDecTauGO             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauGO"]); 
	threshDecTauUBC            = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauUBC"]); 
	...
	threshMaxGO                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxGO"]); 
	...
	rawGRGOW                   = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGRGOW"]); 
	rawMFGOW                   = std::stof(s_file.parsed_var_sections["activity"].param_map["rawMFGOW"]); 
