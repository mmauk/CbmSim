...
{
	/* int con params */
	mf_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["mf_x"]); 
	mf_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["mf_y"]);
	num_mf                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_mf"]); 
	gl_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["gl_x"]); 
	gl_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["gl_y"]); 
	num_gl                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_gl"]); 
	...
	go_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_x"]);
	go_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_y"]); 
	num_go                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_go"]); 
	ubc_x                        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["ubc_x"]); 
	ubc_y                        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["ubc_y"]); 
	num_ubc                      = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_ubc"]); 
	...
	span_mf_to_gl_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_mf_to_gl_x"]); 
	span_mf_to_gl_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_mf_to_gl_y"]); 
	num_p_mf_to_gl               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_mf_to_gl"]); 
	max_num_p_mf_from_mf_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_gl"]); 
	initial_mf_output            = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["initial_mf_output"]); 
	max_mf_to_gl_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_mf_to_gl_attempts"]); 
	span_gl_to_gr_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_gr_x"]); 
	span_gl_to_gr_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_gr_y"]); 
	num_p_gl_to_gr               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_gl_to_gr"]); 
	low_num_p_gl_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_num_p_gl_from_gl_to_gr"]); 
	max_num_p_gr_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_gl_to_gr"]);
	max_num_p_gl_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_gl_to_gr"]);
	low_gl_to_gr_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_gl_to_gr_attempts"]);
	max_gl_to_gr_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_gl_to_gr_attempts"]);
	span_pf_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_pf_to_go_x"]);
	span_pf_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_pf_to_go_y"]);
	num_p_pf_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_pf_to_go"]);
	max_num_p_go_from_gr_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_gr_to_go"]);
	max_num_p_gr_from_gr_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_gr_to_go"]);
	max_pf_to_go_input           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_pf_to_go_input"]);
	max_pf_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_pf_to_go_attempts"]);
	span_aa_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_aa_to_go_x"]);
	span_aa_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_aa_to_go_y"]);
	num_p_aa_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_aa_to_go"]);
	max_aa_to_go_input           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_aa_to_go_input"]);
	max_aa_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_aa_to_go_attempts"]);
	span_go_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_x"]);
	span_go_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_y"]);
	num_p_go_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_go"]);
	num_con_go_to_go             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_con_go_to_go"]);
	go_go_recip_cons             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_go_recip_cons"]);
	reduce_base_recip_go_go      = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["reduce_base_recip_go_go"]);
	max_go_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_go_to_go_attempts"]);
	span_go_to_go_gj_x           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_gj_x"]);
	span_go_to_go_gj_y           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_gj_y"]); 
	num_p_go_to_go_gj            = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_go_gj"]);
	span_go_to_gl_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_gl_x"]);
	span_go_to_gl_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_gl_y"]);
	num_p_go_to_gl               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_gl"]);
	max_num_p_gl_from_go_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_go_to_gl"]);
	max_num_p_go_from_go_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_go_to_gl"]);
	max_go_to_gl_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_go_to_gl_attempts"]);
	span_gl_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_go_x"]);
	span_gl_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_go_y"]);
	num_p_gl_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_gl_to_go"]); 
	low_num_p_gl_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_num_p_gl_from_gl_to_go"]);
	max_num_p_gl_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_gl_to_go"]);
	max_num_p_go_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_gl_to_go"]);
	initial_go_input             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["initial_go_input"]);
	low_gl_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_gl_to_go_attempts"]);
	max_gl_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_gl_to_go_attempts"]);
	max_num_p_go_from_go_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_go_to_gr"]);
	max_num_p_gr_from_go_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_go_to_gr"]);
	max_num_p_gr_from_mf_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_mf_to_gr"]);
	max_num_p_mf_from_mf_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_gr"]);
	max_num_p_go_from_mf_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_mf_to_go"]);
	max_num_p_mf_from_mf_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_go"]);
	...
	/* float con params */
	msPerTimeStep            = std::stof(p_file.parsed_var_sections["connectivity"].param_map["msPerTimeStep"]); 
	numPopHistBinsPC         = std::stof(p_file.parsed_var_sections["connectivity"].param_map["numPopHistBinsPC"]); 
	ampl_go_to_go            = std::stof(p_file.parsed_var_sections["connectivity"].param_map["ampl_go_to_go"]); 
	std_dev_go_to_go         = std::stof(p_file.parsed_var_sections["connectivity"].param_map["std_dev_go_to_go"]); 
	p_recip_go_go            = std::stof(p_file.parsed_var_sections["connectivity"].param_map["p_recip_go_go"]); 
	p_recip_lower_base_go_go = std::stof(p_file.parsed_var_sections["connectivity"].param_map["p_recip_lower_base_go_go"]); 
	ampl_go_to_gl            = std::stof(p_file.parsed_var_sections["connectivity"].param_map["ampl_go_to_gl"]); 
	std_dev_go_to_gl_ml      = std::stof(p_file.parsed_var_sections["connectivity"].param_map["std_dev_go_to_gl_ml"]); 
	std_dev_go_to_gl_s       = std::stof(p_file.parsed_var_sections["connectivity"].param_map["std_dev_go_to_gl_s"]); 

	/* act params */
	eLeakGO      = std::stof(p_file.parsed_var_sections["activity"].param_map["eLeakGO"]); 
	threshRestGO = std::stof(p_file.parsed_var_sections["activity"].param_map["threshRestGO"]); 
	...
	initSynWofMFtoNC = std::stof(p_file.parsed_var_sections["activity"].param_map["initSynWofMFtoNC"]);
