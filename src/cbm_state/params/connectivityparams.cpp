...
{
	/* int con params */
	mf_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["mf_x"].value); 
	mf_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["mf_y"].value);
	num_mf                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_mf"].value); 
	gl_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["gl_x"].value); 
	gl_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["gl_y"].value); 
	num_gl                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_gl"].value); 
	...
	go_x                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_x"].value);
	go_y                         = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_y"].value); 
	num_go                       = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_go"].value); 
	ubc_x                        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["ubc_x"].value); 
	ubc_y                        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["ubc_y"].value); 
	num_ubc                      = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_ubc"].value); 
	...
	span_mf_to_gl_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_mf_to_gl_x"].value); 
	span_mf_to_gl_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_mf_to_gl_y"].value); 
	num_p_mf_to_gl               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_mf_to_gl"].value); 
	max_num_p_mf_from_mf_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_gl"].value); 
	initial_mf_output            = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["initial_mf_output"].value); 
	max_mf_to_gl_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_mf_to_gl_attempts"].value); 
	span_gl_to_gr_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_gr_x"].value); 
	span_gl_to_gr_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_gr_y"].value); 
	num_p_gl_to_gr               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_gl_to_gr"].value); 
	low_num_p_gl_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_num_p_gl_from_gl_to_gr"].value); 
	max_num_p_gr_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_gl_to_gr"].value);
	max_num_p_gl_from_gl_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_gl_to_gr"].value);
	low_gl_to_gr_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_gl_to_gr_attempts"].value);
	max_gl_to_gr_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_gl_to_gr_attempts"].value);
	span_pf_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_pf_to_go_x"].value);
	span_pf_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_pf_to_go_y"].value);
	num_p_pf_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_pf_to_go"].value);
	max_num_p_go_from_gr_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_gr_to_go"].value);
	max_num_p_gr_from_gr_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_gr_to_go"].value);
	max_pf_to_go_input           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_pf_to_go_input"].value);
	max_pf_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_pf_to_go_attempts"].value);
	span_aa_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_aa_to_go_x"].value);
	span_aa_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_aa_to_go_y"].value);
	num_p_aa_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_aa_to_go"].value);
	max_aa_to_go_input           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_aa_to_go_input"].value);
	max_aa_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_aa_to_go_attempts"].value);
	span_go_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_x"].value);
	span_go_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_y"].value);
	num_p_go_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_go"].value);
	num_con_go_to_go             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_con_go_to_go"].value);
	go_go_recip_cons             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["go_go_recip_cons"].value);
	reduce_base_recip_go_go      = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["reduce_base_recip_go_go"].value);
	max_go_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_go_to_go_attempts"].value);
	span_go_to_go_gj_x           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_gj_x"].value);
	span_go_to_go_gj_y           = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_go_gj_y"].value); 
	num_p_go_to_go_gj            = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_go_gj"].value);
	span_go_to_gl_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_gl_x"].value);
	span_go_to_gl_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_go_to_gl_y"].value);
	num_p_go_to_gl               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_go_to_gl"].value);
	max_num_p_gl_from_go_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_go_to_gl"].value);
	max_num_p_go_from_go_to_gl   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_go_to_gl"].value);
	max_go_to_gl_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_go_to_gl_attempts"].value);
	span_gl_to_go_x              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_go_x"].value);
	span_gl_to_go_y              = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["span_gl_to_go_y"].value);
	num_p_gl_to_go               = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["num_p_gl_to_go"].value); 
	low_num_p_gl_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_num_p_gl_from_gl_to_go"].value);
	max_num_p_gl_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gl_from_gl_to_go"].value);
	max_num_p_go_from_gl_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_gl_to_go"].value);
	initial_go_input             = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["initial_go_input"].value);
	low_gl_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["low_gl_to_go_attempts"].value);
	max_gl_to_go_attempts        = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_gl_to_go_attempts"].value);
	max_num_p_go_from_go_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_go_to_gr"].value);
	max_num_p_gr_from_go_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_go_to_gr"].value);
	max_num_p_gr_from_mf_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_gr_from_mf_to_gr"].value);
	max_num_p_mf_from_mf_to_gr   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_gr"].value);
	max_num_p_go_from_mf_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_go_from_mf_to_go"].value);
	max_num_p_mf_from_mf_to_go   = std::stoi(p_file.parsed_var_sections["connectivity"].param_map["max_num_p_mf_from_mf_to_go"].value);
	...
	p_recip_lower_base_go_go = std::stof(p_file.parsed_var_sections["connectivity"].param_map["p_recip_lower_base_go_go"].value); 
