 ...
 * 			pointed to by fp. Does not check whether fp is valid
 * (TODO)
 *
...
/*
 * DESCRIP: obtains one character from the tty associated with fp. Again, does
 * not check whether fp is valid.
 *
...
/*
 * DESCRIP: processes input for the tty pointed to by fp. respons to 'p' for
 * 'pause' and 'c' for continue, if paused already.
 */
 ...
 *
 * RETURNS: 0 on successfully completing the above tasks. TODO: need to check
 * for failure.
 */
