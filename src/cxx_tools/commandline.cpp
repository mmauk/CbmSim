...
void print_usage_info() {
  ...
  std::cout << std::right << std::setw(10)
            << "\t--pfpc-off|--binary|--abbott-cascade|--mauk-cascade"
  ...
  std::cout << "\t\t\t\t \t--abbott-cascade - turns PFPC plasticity on and "
               "sets the type of plasticity to 'abbott cascade'\n\n";
  std::cout << "\t\t\t\t \t--mauk-cascade - turns PFPC plasticity on and sets "
               "the type of plasticity to 'mauk cascade'\n\n";
  std::cout << std::right << std::setw(10) << "\t"
