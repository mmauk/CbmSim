...
{
	coupleRiRjRatioGO       = std::stof(p_file.parsed_sections["activity"].param_map["coupleRiRjRatioGO"].value); 
	coupleRiRjRatioIO       = std::stof(p_file.parsed_sections["activity"].param_map["coupleRiRjRatioIO"].value); 
	eBCtoPC                 = std::stof(p_file.parsed_sections["activity"].param_map["eBCtoPC"].value); 
	eGABAGO                 = std::stof(p_file.parsed_sections["activity"].param_map["eGABAGO"].value); 
	eGOGR                   = std::stof(p_file.parsed_sections["activity"].param_map["eGOGR"].value); 
	eLeakBC                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakBC"].value); 
	eLeakGO                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakGO"].value); 
	eLeakGR                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakGR"].value); 
	eLeakIO                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakIO"].value); 
	eLeakNC                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakNC"].value); 
	eLeakPC                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakPC"].value); 
	eLeakSC                 = std::stof(p_file.parsed_sections["activity"].param_map["eLeakSC"].value); 
	eMFGR                   = std::stof(p_file.parsed_sections["activity"].param_map["eMFGR"].value); 
	eMGluRGO                = std::stof(p_file.parsed_sections["activity"].param_map["eMGluRGO"].value); 
	eNCtoIO                 = std::stof(p_file.parsed_sections["activity"].param_map["eNCtoIO"].value); 
	ePCtoBC                 = std::stof(p_file.parsed_sections["activity"].param_map["ePCtoBC"].value); 
	ePCtoNC                 = std::stof(p_file.parsed_sections["activity"].param_map["ePCtoNC"].value); 
	eSCtoPC                 = std::stof(p_file.parsed_sections["activity"].param_map["eSCtoPC"].value); 
	gDecTauBCtoPC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauBCtoPC"].value); 
	gIncBCtoPC              = std::stof(p_file.parsed_sections["activity"].param_map["gIncBCtoPC"].value); 
	gGABADecTauGOtoGO       = std::stof(p_file.parsed_sections["activity"].param_map["gGABADecTauGOtoGO"].value); 
	gIncDirectGOtoGR        = std::stof(p_file.parsed_sections["activity"].param_map["gIncDirectGOtoGR"].value); 
	gDirectTauGOtoGR        = std::stof(p_file.parsed_sections["activity"].param_map["gDirectTauGOtoGR"].value); 
	gIncFracSpilloverGOtoGR = std::stof(p_file.parsed_sections["activity"].param_map["gIncFracSpilloverGOtoGR"].value); 
	gSpilloverTauGOtoGR     = std::stof(p_file.parsed_sections["activity"].param_map["gSpilloverTauGOtoGR"].value); 
	gGABAIncGOtoGO          = std::stof(p_file.parsed_sections["activity"].param_map["gGABAIncGOtoGO"].value); 
	gDecTauGRtoGO           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauGRtoGO"].value); 
	gIncGRtoGO              = std::stof(p_file.parsed_sections["activity"].param_map["gIncGRtoGO"].value); 
	gDecTauMFtoGO           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauMFtoGO"].value); 
	gIncMFtoGO              = std::stof(p_file.parsed_sections["activity"].param_map["gIncMFtoGO"].value); 
	gConstGO                = std::stof(p_file.parsed_sections["activity"].param_map["gConstGO"].value); 
	NMDA_AMPAratioMFGO      = std::stof(p_file.parsed_sections["activity"].param_map["NMDA_AMPAratioMFGO"].value); 
	gDecTauMFtoGONMDA       = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauMFtoGONMDA"].value); 
	gIncDirectMFtoGR        = std::stof(p_file.parsed_sections["activity"].param_map["gIncDirectMFtoGR"].value); 
	gDirectTauMFtoGR        = std::stof(p_file.parsed_sections["activity"].param_map["gDirectTauMFtoGR"].value); 
	gIncFracSpilloverMFtoGR = std::stof(p_file.parsed_sections["activity"].param_map["gIncFracSpilloverMFtoGR"].value); 
	gSpilloverTauMFtoGR     = std::stof(p_file.parsed_sections["activity"].param_map["gSpilloverTauMFtoGR"].value); 
	recoveryTauMF           = std::stof(p_file.parsed_sections["activity"].param_map["recoveryTauMF"].value); 
	fracDepMF               = std::stof(p_file.parsed_sections["activity"].param_map["fracDepMF"].value); 
	recoveryTauGO           = std::stof(p_file.parsed_sections["activity"].param_map["recoveryTauGO"].value); 
	fracDepGO               = std::stof(p_file.parsed_sections["activity"].param_map["fracDepGO"].value); 
	gIncMFtoUBC             = std::stof(p_file.parsed_sections["activity"].param_map["gIncMFtoUBC"].value); 
	gIncGOtoUBC             = std::stof(p_file.parsed_sections["activity"].param_map["gIncGOtoUBC"].value); 
	gIncUBCtoUBC            = std::stof(p_file.parsed_sections["activity"].param_map["gIncUBCtoUBC"].value); 
	gIncUBCtoGO             = std::stof(p_file.parsed_sections["activity"].param_map["gIncUBCtoGO"].value); 
	gIncUBCtoGR             = std::stof(p_file.parsed_sections["activity"].param_map["gIncUBCtoGR"].value); 
	gKIncUBC                = std::stof(p_file.parsed_sections["activity"].param_map["gKIncUBC"].value); 
	gKTauUBC                = std::stof(p_file.parsed_sections["activity"].param_map["gKTauUBC"].value); 
	gConstUBC               = std::stof(p_file.parsed_sections["activity"].param_map["gConstUBC"].value); 
	threshTauUBC            = std::stof(p_file.parsed_sections["activity"].param_map["threshTauUBC"].value); 
	gMGluRDecGRtoGO         = std::stof(p_file.parsed_sections["activity"].param_map["gMGluRDecGRtoGO"].value); 
	gMGluRIncDecayGO        = std::stof(p_file.parsed_sections["activity"].param_map["gMGluRIncDecayGO"].value); 
	gMGluRIncScaleGO        = std::stof(p_file.parsed_sections["activity"].param_map["gMGluRIncScaleGO"].value); 
	gMGluRScaleGRtoGO       = std::stof(p_file.parsed_sections["activity"].param_map["gMGluRScaleGRtoGO"].value); 
	gDecT0ofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["gDecT0ofNCtoIO"].value); 
	gDecTSofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["gDecTSofNCtoIO"].value); 
	gDecTTofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["gDecTTofNCtoIO"].value); 
	gIncNCtoIO              = std::stof(p_file.parsed_sections["activity"].param_map["gIncNCtoIO"].value); 
	gIncTauNCtoIO           = std::stof(p_file.parsed_sections["activity"].param_map["gIncTauNCtoIO"].value); 
	gDecTauPCtoBC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauPCtoBC"].value); 
	gDecTauPCtoNC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauPCtoNC"].value); 
	gIncAvgPCtoNC           = std::stof(p_file.parsed_sections["activity"].param_map["gIncAvgPCtoNC"].value); 
	gDecTauGRtoBC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauGRtoBC"].value); 
	gDecTauGRtoPC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauGRtoPC"].value); 
	gDecTauGRtoSC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauGRtoSC"].value); 
	gIncGRtoPC              = std::stof(p_file.parsed_sections["activity"].param_map["gIncGRtoPC"].value); 
	gDecTauSCtoPC           = std::stof(p_file.parsed_sections["activity"].param_map["gDecTauSCtoPC"].value); 
	gIncSCtoPC              = std::stof(p_file.parsed_sections["activity"].param_map["gIncSCtoPC"].value);  
	gluDecayGO              = std::stof(p_file.parsed_sections["activity"].param_map["gluDecayGO"].value); 
	gluScaleGO              = std::stof(p_file.parsed_sections["activity"].param_map["gluScaleGO"].value); 
	goGABAGOGOSynDepF       = std::stof(p_file.parsed_sections["activity"].param_map["goGABAGOGOSynDepF"].value); 
	goGABAGOGOSynRecTau     = std::stof(p_file.parsed_sections["activity"].param_map["goGABAGOGOSynRecTau"].value); 
	synLTDStepSizeGRtoPC    = std::stof(p_file.parsed_sections["activity"].param_map["synLTDStepSizeGRtoPC"].value); 
	synLTPStepSizeGRtoPC    = std::stof(p_file.parsed_sections["activity"].param_map["synLTPStepSizeGRtoPC"].value); 
	mGluRDecayGO            = std::stof(p_file.parsed_sections["activity"].param_map["mGluRDecayGO"].value); 
	mGluRScaleGO            = std::stof(p_file.parsed_sections["activity"].param_map["mGluRScaleGO"].value); 
	maxExtIncVIO            = std::stof(p_file.parsed_sections["activity"].param_map["maxExtIncVIO"].value); 
	gmaxAMPADecTauMFtoNC    = std::stof(p_file.parsed_sections["activity"].param_map["gmaxAMPADecTauMFtoNC"].value); 
	synLTDStepSizeMFtoNC    = std::stof(p_file.parsed_sections["activity"].param_map["synLTDStepSizeMFtoNC"].value); 
	synLTDPCPopActThreshMFtoNC = std::stof(p_file.parsed_sections["activity"].param_map["synLTDPCPopActThreshMFtoNC"].value); 
	synLTPStepSizeMFtoNC       = std::stof(p_file.parsed_sections["activity"].param_map["synLTPStepSizeMFtoNC"].value); 
	synLTPPCPopActThreshMFtoNC = std::stof(p_file.parsed_sections["activity"].param_map["synLTPPCPopActThreshMFtoNC"].value); 
	gmaxNMDADecTauMFtoNC       = std::stof(p_file.parsed_sections["activity"].param_map["gmaxNMDADecTauMFtoNC"].value); 
	initSynWofMFtoNC           = std::stof(p_file.parsed_sections["activity"].param_map["initSynWofMFtoNC"].value); 
	msLTDDurationIO            = std::stof(p_file.parsed_sections["activity"].param_map["msLTDDurationIO"].value); 
	msLTDStartAPIO             = std::stof(p_file.parsed_sections["activity"].param_map["msLTDStartAPIO"].value); 
	msLTPEndAPIO               = std::stof(p_file.parsed_sections["activity"].param_map["msLTPEndAPIO"].value); 
	msLTPStartAPIO             = std::stof(p_file.parsed_sections["activity"].param_map["msLTPStartAPIO"].value); 
	msPerHistBinGR             = std::stof(p_file.parsed_sections["activity"].param_map["msPerHistBinGR"].value); 
	msPerHistBinMF             = std::stof(p_file.parsed_sections["activity"].param_map["msPerHistBinMF"].value); 
	msPerTimeStep              = std::stof(p_file.parsed_sections["activity"].param_map["msPerTimeStep"].value); 
	relPDecT0ofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["relPDecT0ofNCtoIO"].value); 
	relPDecTSofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["relPDecTSofNCtoIO"].value); 
	relPDecTTofNCtoIO          = std::stof(p_file.parsed_sections["activity"].param_map["relPDecTTofNCtoIO"].value); 
	relPIncNCtoIO              = std::stof(p_file.parsed_sections["activity"].param_map["relPIncNCtoIO"].value); 
	relPIncTauNCtoIO           = std::stof(p_file.parsed_sections["activity"].param_map["relPIncTauNCtoIO"].value); 
	gIncPCtoBC                 = std::stof(p_file.parsed_sections["activity"].param_map["gIncPCtoBC"].value); 
	gIncGRtoBC                 = std::stof(p_file.parsed_sections["activity"].param_map["gIncGRtoBC"].value); 
	gIncGRtoSC                 = std::stof(p_file.parsed_sections["activity"].param_map["gIncGRtoSC"].value); 
	initSynWofGRtoPC           = std::stof(p_file.parsed_sections["activity"].param_map["initSynWofGRtoPC"].value); 
	rawGLeakBC                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakBC"].value); 
	rawGLeakGO                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakGO"].value); 
	rawGLeakGR                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakGR"].value); 
	rawGLeakIO                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakIO"].value); 
	rawGLeakNC                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakNC"].value); 
	rawGLeakPC                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakPC"].value); 
	rawGLeakSC                 = std::stof(p_file.parsed_sections["activity"].param_map["rawGLeakSC"].value); 
	rawGMFAMPAIncNC            = std::stof(p_file.parsed_sections["activity"].param_map["rawGMFAMPAIncNC"].value); 
	rawGMFNMDAIncNC            = std::stof(p_file.parsed_sections["activity"].param_map["rawGMFNMDAIncNC"].value); 
	threshRestBC               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestBC"].value); 
	threshRestGO               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestGO"].value); 
	threshRestGR               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestGR"].value); 
	threshRestIO               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestIO"].value); 
	threshRestNC               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestNC"].value); 
	threshRestPC               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestPC"].value); 
	threshRestSC               = std::stof(p_file.parsed_sections["activity"].param_map["threshRestSC"].value); 
	threshDecTauBC             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauBC"].value); 
	threshDecTauGO             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauGO"].value); 
	threshDecTauUBC            = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauUBC"].value); 
	threshDecTauGR             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauGR"].value); 
	threshDecTauIO             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauIO"].value); 
	threshDecTauNC             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauNC"].value); 
	threshDecTauPC             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauPC"].value); 
	threshDecTauSC             = std::stof(p_file.parsed_sections["activity"].param_map["threshDecTauSC"].value); 
	threshMaxBC                = std::stof(p_file.parsed_sections["activity"].param_map["threshMaxBC"].value); 
	threshMaxGO                = std::stof(p_file.parsed_sections["activity"].param_map["threshMaxGO"].value); 
	threshMaxGR                = std::stof(p_file.parsed_sections["activity"].param_map["threshMaxGR"].value); 
	threshMaxIO                = std::stof(p_file.parsed_sections["activity"].param_map["threshMaxIO"].value); 
